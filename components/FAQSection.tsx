  ...
  const faqs = [
    {
      ...
      answer:
        'いいえ、当サービスは投資助言業ではありません。財務データの分析ツールとして情報提供のみを行っており、具体的な投資判断や推奨は行いません。投資に関する最終的な判断は、必ずお客様ご自身の責任で行ってください。',
    },
    {
      question: 'どのようなデータが取得できますか？',
      answer:
        '日本の上場企業の有価証券報告書から抽出した財務データ、業績指標、企業情報などを提供しています。すべてのデータは公開情報に基づいています。',
    },
    {
    ...
    },
    {
      ...
      answer:
        '公開されている有価証券報告書に基づいてデータを提供していますが、データの正確性や完全性について保証するものではありません。重要な投資判断の際は、必ず一次情報をご確認ください。',
    },
    {
    ...
    },
    {
      question: '商用利用は可能ですか？',
      answer:
        'はい、商用利用が可能です。ただし、取得したデータを第三者に販売した損害。または、AI分析結果に基づく損害について当社は一切の責任を負いかねます。',
    },
  ];
    ...
    <section id="faq" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">XBRL Financial APIについてのよくある質問にお答えします</p>
        </div>
