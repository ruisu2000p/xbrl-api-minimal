...
-- Comment on columns
COMMENT ON COLUMN private.user_subscriptions.last_resolution_path IS 'How the Stripe subscription was resolved: by_subscription_id | by_customer_id | by_email_search | self_healed';
COMMENT ON COLUMN private.user_subscriptions.last_resolved_at IS 'When the Stripe subscription was last resolved';
