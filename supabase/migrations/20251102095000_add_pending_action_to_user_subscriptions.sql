...
-- Comment on column
COMMENT ON COLUMN public.user_subscriptions.pending_action IS 'Pending operation awaiting webhook confirmation: downgrade_to_freemium | cancel_immediate | null';
